...
logging.basicConfig(filename='informacija.log', level=logging.INFO, format='%(asctime)s, %(levelname)s, %(message)s')
...
logging.basicConfig(filename='inform.log', level=logging.INFO, format='%(asctime)s, %(levelname)s, %(message)s')
...
file_handler = logging.FileHandler('inform.log')
