class Sakinys:
    ...
    def default(self, didziosios_tekstas, mazosios_tekstas):
        if self.tekstas == "default":
            return didziosios_tekstas.upper() + " " + mazosios_tekstas.lower()
        else:
...
## 2 uzduotis
sakinys1 = Sakinys()
print(sakinys1.default("Tekstas DIDŽIOSIOMIS", "tekstas mažosiomis"))
# Output: TEKSTAS DIDŽIOSIOMIS tekstas mažosiomis

sakinys2 = Sakinys("Testinis TEKSTAS")
print(sakinys2.default("Tekstas DIDŽIOSIOMIS", "tekstas mažosiomis"))
# Output: Tekstas: Testinis TEKSTAS